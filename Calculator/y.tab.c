...
{
      18,     0,    -1,    18,    19,    13,    -1,    18,     1,    13,
      -1,    -1,    20,    -1,     4,    14,    20,    -1,    15,    20,
...
{
       0,    25,    25,    27,    31,    33,    38,    45,    50,    56,
      61,    66,    71,    76,    81,    87,    92,    98,   101,   106
};
#endif
...
#line 107 "calc.y"
    {
           (yyval.a) = base * (yyvsp[(1) - (2)].a) + (yyvsp[(2) - (2)].a);
         }
    break;
